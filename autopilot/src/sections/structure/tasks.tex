...
\includegraphics[]{autopilot/autopilot/src/figures/side_17_protocol.pdf}
...
\draw[<-] (pic cs:data) ++(0,0.1) to[left] ++(5.5,0) --++(0,-0.9) --++(0.2,0)node[below right, yshift=8pt, text width=2.4in]{\textcolor{red}{2) A \texttt{Trial\_Data} model} defines what data will be returned from the task. };
...
\includegraphics[]{autopilot/autopilot/src/figures/side_18_maze.pdf}
