...
For brevity we have omitted many other excellent tools that perform some subset of the operations of a complete behavioral system, or are otherwise have a substantial difference in scope.\sidenote[][1cm]{\textbf{Other tools:}\\
