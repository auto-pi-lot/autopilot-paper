...
\includegraphics[]{autopilot/autopilot/src/figures/test_5_gonogo.pdf}
...
\begin{marginfigure}[-0cm]
\includegraphics[]{autopilot/autopilot/src/figures/test_6_visual_lags.pdf}
...
\includegraphics[]{autopilot/autopilot/src/figures/test_7_fps.pdf}
