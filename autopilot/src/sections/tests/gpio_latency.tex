...
\toprule
\textbf{Code} & \href{https://github.com/auto-pi-lot/plugin-paper/blob/main/plugin_tests/scripts/test_gpio.py}{test\_gpio.py} \\
\textbf{gpiozero} & link to gpiozero class \\
\textbf{pigpio} & version \\
\bottomrule
\end{tabularx}
\end{margintable}
...
\noindent\begin{tabularx}{\linewidth}{lX}%
\toprule
\textbf{Function Generator} & model number \\
\textbf{Code} & link to code \\
\bottomrule
\end{tabularx}
\end{margintable}
